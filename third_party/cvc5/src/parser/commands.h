...
class CVC5_EXPORT GetAbductCommand : public Cmd
{
 public:
  ...
  /**
   * Constructor with grammar assertion names.
   * @param name The name of the abduction predicate.
   * @param conj The conjecture to abduce.
   * @param g The (optional) grammar for the abduct.
   * @param grammarAssertionNames Named assertions to use for grammar generation.
   */
  GetAbductCommand(const std::string& name,
                   cvc5::Term conj,
                   cvc5::Grammar* g,
 ...
 protected:
  ...
  cvc5::Grammar* d_sygus_grammar;
  /** The (optional) named assertions to use for grammar generation */
  std::vector<std::string> d_grammarAssertionNames;
  /** Whether :grammar-assertions was specified (even if empty) */
  bool d_useGrammarAssertions;
  /** the return expression of the command */
  cvc5::Term d_result;
