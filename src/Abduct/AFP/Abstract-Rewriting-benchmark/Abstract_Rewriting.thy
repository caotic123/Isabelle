...
(*      have "(b, c) \<in> (A\<^sup>\<leftrightarrow>)\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  ultimately have "\<not> SN_on r A" unfolding SN_defs *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      ultimately show "(?f i, ?f (Suc i)) \<in> r" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      case (r_into_trancl x y) then show ?case unfolding restrict_SN_def *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof (intro iffI subrelI)
  ...
  proof (induct n arbitrary: x)
    case 0
(*    assume "(x, y) \<in> r\<^sup>\<leftrightarrow> ^^ 0" then have "x = y" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show ?case unfolding \<open>x = y\<close> *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
  ...
  next
    ...
    proof
(*      assume "(x, z) \<in> r" with \<open>(z, y) \<in> r\<^sup>\<down>\<close> show ?thesis *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof
(*  show "r\<^sup>\<leftrightarrow>\<^sup>* \<subseteq> r\<^sup>\<down>" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
next
(*  show "r\<^sup>\<down> \<subseteq> r\<^sup>\<leftrightarrow>\<^sup>*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof -
(*  have "r\<^sup>\<leftrightarrow>\<^sup>* = r\<^sup>\<down>" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  have "?S 0 = x" *)
  ...
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      ...
      1\<close>)
  proof
(*    fix i show "(?S i,?S(Suc i)) \<in> r \<and> ?S(Suc i) \<in> Q" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*          moreover from \<open>(t, u) \<in> r\<^sup>*\<close> and \<open>(u, v) \<in> r\<^sup>*\<close> have "(t, v) \<in> r\<^sup>*" *)
          apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
              @{context}
              {max_facts = {cvc5 = SOME 5, e = NONE},
               max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*          ultimately have "(z, v) \<in> r\<^sup>\<down>" *)
          apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
              @{context}
              {max_facts = {cvc5 = SOME 5, e = NONE},
               max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    moreover from chain have "chain r (f \<circ> Suc)" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof - {
(*  fix x y assume "(x, y) \<in> ?r\<^sup>*" then have "(x, y) \<in> r\<^sup>*" unfolding restrict_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof -
  ...
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      ...
      1\<close>)
  proof
(*    fix y have "y \<notin> ?S \<or> y \<in> ?S" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
    ...
    then show "SN_on ?r {y}"
    proof
(*      assume "y \<notin> ?S" then show ?thesis unfolding restrict_def *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*        show "\<exists>b. (c, b) \<in> r \<and> b \<in> ?Q" *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      case base then show ?case *)
    ...
    next
      ...
      proof
(*        assume "(y, z) \<in> r" then show ?thesis *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  ultimately have "?f 0 \<in> {f i} \<and> chain r ?f" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have ini: "\<forall>i<?i. (S i, S(Suc i)) \<in> s" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      and chain have "\<not> SN_on (r \<union> s) {S (Suc ?i)}" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      and \<open>\<not> SN_on (r \<union> s) {S(Suc ?i)}\<close> have "\<not> SN_on (r \<union> s) {c}" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof (rule subrelI)
(*  fix a b assume "(a, b) \<in> restrict_SN R S" then show "(a, b) \<in> R" unfolding restrict_SN_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  have "\<forall>j<?i. (t j, t (Suc j)) \<notin> R" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  moreover with assms have "\<forall>j<?i. (t j, t (Suc j)) \<in> S" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  ultimately have "\<forall>j<?i. (t j, t (Suc j)) \<in> S \<and> (t j, t (Suc j)) \<notin> R" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    case base then show ?case *)
  ...
  next
    ...
    then show ?case
    proof (cases "(x, y) \<in> R\<^sup>*")
(*      case False with step have "(x, y) \<in> R\<^sup>* O S O ?SR\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have "(y, z) \<in> S" *)
      ...
      have "(y, z) \<in> S" 
      proof (rule ccontr)
(*        assume "(y, z) \<notin> S" with \<open>(y, z) \<in> ?SR\<close> have "(y, z) \<in> R" *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  ultimately show False unfolding SN_defs *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have "NS O NS\<^sup>* \<subseteq> NS\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  also have "\<dots> \<subseteq> ?NSS O S \<union> NS\<^sup>* O S" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  also have "\<dots> \<subseteq> ?NSS O S \<union> S" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  also have "\<dots> \<subseteq> S O ?NSuS\<^sup>*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  finally have "?midS \<subseteq> S O ?NSuS\<^sup>* O ?NSuS\<^sup>*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have "\<lbrakk>(x, z) \<in> B\<^sup>*; (z, y) \<in> B\<^sup>*\<rbrakk> \<Longrightarrow> (x, y) \<in> B\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have "A O A\<^sup>* O (A - B) O A\<^sup>* \<subseteq> A\<^sup>* O (A - B) O A\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof -
(*  have RS: "R - D \<union> (S - D) = R \<union> S - D" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  have as: "\<And> i. (as i, as (Suc i)) \<in> R \<union> S"
    and inf: "INFM i. (as i, as (Suc i)) \<in> R"*)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  ultimately have "\<exists>!b. (a, b) \<in> A\<^sup>!" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      case 0 from seq0 show ?case *)
    ...
    next
(*      case (Suc i) with chain have "seq (Suc i) \<in> ((S O R)\<^sup>* O S O R) `` X" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      also have "... \<subseteq> (S O R)\<^sup>* `` X" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*        also have "... \<subseteq> R O S\<^sup>* O S\<^sup>*" *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  also have "... \<subseteq> (S\<^sup>* O R)\<^sup>* O S\<^sup>*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      also have "... \<subseteq> R\<^sup>* O S\<^sup>* O R" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      also have "... \<subseteq> R\<^sup>* O R O S\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      also have "... \<subseteq> R\<^sup>* O S\<^sup>*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    also from rtrancl_O_push have "... \<subseteq> R O S\<^sup>* O S\<^sup>*" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    finally have t3: "(t, seq 3) \<in> R O S\<^sup>*" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*          case 0 with st show ?thesis *)
        ...
        next
(*          case (Suc i) with t3 IH show ?thesis *)
          apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
              @{context}
              {max_facts = {cvc5 = SOME 5, e = NONE},
               max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  moreover have "Id \<subseteq> r" by(fact assms(2)[unfolded refl_O_iff]) *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      ...
      1\<close>)
  moreover have "Id \<subseteq> r" by(fact assms(2)[unfolded refl_O_iff])
(*  ultimately show "r \<subseteq> r O r" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
