...
(*  also have "\<dots> \<le> - \<delta> * ((f 0 - a) / \<delta>)" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  finally have "\<not> ?gt (f i) a" unfolding delta_gt_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show ?thesis unfolding delta_gt_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show ?thesis *)
  ...
  show ?thesis
  proof (unfold_locales)
(*    show "SN {(x,y). y \<ge> 0 \<and> delta_gt \<delta> x y}" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have one: "delta_gt \<delta> (x ^ Suc (Suc p)) (x * y ^ Suc p)" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof (unfold_locales)
(*  have [simp]: "\<And> x :: int . (-1 < x) = (0 \<le> x)" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
next
  fix x :: arctic
(*  show "pos_arctic 1" unfolding one_arctic_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show "x > 0" unfolding zero_arctic_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show "(1 :: arctic) \<ge> 0" unfolding zero_arctic_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show "x \<ge> 0" unfolding zero_arctic_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show "\<not> pos_arctic 0" unfolding zero_arctic_def *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  show "SN {(x,y). pos_arctic y \<and> x > y}" (is "SN ?rel") *)
  ...
  proof - {
    ...
    proof
      ...
      with fi fsi gz
(*      show "?g (Suc i) \<ge> 0 \<and> ?g i > ?g (Suc i)" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof -
  ...
  next
    fix x
(*    show "pos_arctic_delta 1" unfolding one_arctic_delta_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "gt_arctic_delta \<delta> x 0" unfolding zero_arctic_delta_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "(1 :: 'a arctic_delta) \<ge> 0" unfolding zero_arctic_delta_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "x \<ge> 0" unfolding zero_arctic_delta_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "\<not> pos_arctic_delta 0" unfolding zero_arctic_delta_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "SN {(x,y). pos_arctic_delta y \<and> gt_arctic_delta \<delta> x y}" (is "SN ?rel") *)
    ...
    proof - {
      ...
      proof
        ...
        with fi fsi gz
(*        show "?g (Suc i) \<ge> 0 \<and> delta_gt \<delta> (?g i) (?g (Suc i))" *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
