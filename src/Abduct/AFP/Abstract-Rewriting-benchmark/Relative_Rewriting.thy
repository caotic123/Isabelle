...
proof -
  let ?RS = "relto R S"
(*  have "(R \<union> S)^* \<subseteq> S^* \<union> ?RS^*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have r_index: "\<And> i. r (r_index i) \<and> r_index i < r_index (Suc i) \<and> (\<forall> j. r_index i < j \<and> j < r_index (Suc i) \<longrightarrow> \<not> r j)" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have g0: "g 0 = a 0" unfolding g Let_def *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "\<not> (\<forall> m. \<exists> n \<ge> m. (f n, f (Suc n)) \<in> R)" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show "\<not> (INFM j. (as j, as (Suc j)) \<in> R)" unfolding INFM_nat *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have "\<exists> ty. (g i, g (Suc i)) \<in> ?rel ty" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      show ?thesis unfolding normal_s *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      show ?thesis unfolding normal_ns *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      show "INFM i. ?ty i \<in> {top_s, normal_s}"
    ...
    next
      fix i
(*      have A: "A \<subseteq> Ms" unfolding A *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have PM: "?P \<subseteq> Ms^* O Ms O Ms^*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have PwM: "?Pw \<subseteq> Ms^* O Ms O Ms^*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      have RM: "?R \<subseteq> Ms^* O Ms O Ms^*" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*        also have "... \<subseteq> Ms" unfolding Ms *)
        apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
            @{context}
            {max_facts = {cvc5 = SOME 5, e = NONE},
             max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have "(f s, f t) \<in> ?P" and I: "I t" *)
    ...
    from su uv vt I 
(*    show "(f s, f t) \<in> ?P' \<and> I t" unfolding Ms *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have steps: "(f s, f t) \<in> ?Rw" and I: "I t" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      moreover have "(f (g i), f (g (Suc i))) \<in> r \<union> s" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*      ultimately show "(f (g i), f (g (Suc i))) \<in> s" *)
      apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
          @{context}
          {max_facts = {cvc5 = SOME 5, e = NONE},
           max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    show ?thesis unfolding SN_trancl_SN_conv *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
proof -
(*  have "relto a b \<subseteq> (a \<union> b)^+" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  have 1: "as1 0 = a" "as1 m1 = b"
    ...
    "n1 = 0 \<longleftrightarrow> m1 = 0" and card1: "n1 = card {i. i < m1 \<and> sel1 i}"*)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  have 2: "as2 0 = b" "as2 m2 = c"
    ...
    "n2 = 0 \<longleftrightarrow> m2 = 0" and card2: "n2 = card {i. i < m2 \<and> sel2 i}"*)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    finally show "?n = card { i . i < ?m \<and> ?sel i}" unfolding card1 card2 id *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  moreover from uv have uv: "(u,v) \<in> (R \<union> E)^*" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have "\<exists> j. \<forall> i \<ge> j. (f i, f (Suc i)) \<in> relto R' S - relto R S" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    ultimately have "\<not> SN_on (relto R' S) X" *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
