...
(*    show ?thesis unfolding trancl_power *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*  moreover have "\<And>i. P (f (\<phi> i)) (f (\<phi> (Suc i)))" *)
  apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
      @{context}
      {max_facts = {cvc5 = SOME 5, e = NONE},
       max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*              show "ll - ?l' < Suc ll \<and> 0 < n (Suc ll)" *)
              apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
                  @{context}
                  {max_facts = {cvc5 = SOME 5, e = NONE},
                   max_limit = {cvc5 = SOME 1, e = SOME 1},
...
(*    have "f (Suc i) 0 = f ?i' 0" unfolding ii' *)
    apply (tactic \<open>Mini_Abduct_Sledgehammer.abduct_sledgehammer_tac_depth
        @{context}
        {max_facts = {cvc5 = SOME 5, e = NONE},
         max_limit = {cvc5 = SOME 1, e = SOME 1},
