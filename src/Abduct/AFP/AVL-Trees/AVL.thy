...
ML_file \<open>../../cvc5_abduct_setup.ML\<close>
declare [[smt_solver = cvc5_abduct_trace]]
declare [[cvc5_abduct_trace_options = "--sygus-stream --tlimit-per 10000"]]
declare [[cvc5_options = "--proof-alethe-experimental"]]
ML_file \<open>../../mini_abduct_sledgehammer.ML\<close>
declare [[names_short]]
